...
var MainScene = /** @class */ (function (_super) {
    ...
    function MainScene(param) {
        ...
        _this.loaded.add(function () {
            ...
            //手数
            uiBase.append(new g.Sprite({ scene: _this, src: _this.assets["score"], x: 505, y: 85, height: 32, srcY: 64 }));
            var labelTekazu = new g.Label({
                scene: _this,
                x: 542,
                y: 85,
                width: 32 * 3,
            ...
            _this.setTekazu = function (num) {
                labelTekazu.text = "" + num;
                labelTekazu.invalidate();
            };
            //最短手数
            uiBase.append(new g.Sprite({ scene: _this, src: _this.assets["score"], x: 505, y: 125, height: 32, srcY: 96 }));
            var labelSaitan = new g.Label({
                scene: _this,
                x: 542,
                y: 125,
                width: 32 * 3,
            ...
            _this.setSaitan = function (num) {
                labelSaitan.text = "" + num;
                labelSaitan.invalidate();
            };
            //スコア
            uiBase.append(new g.Sprite({ scene: _this, src: _this.assets["score"], x: 505, y: 165, height: 32 }));
            var score = 0;
